import blockchainconsulting from "../assets/blockchainconsulting.svg";
import qualityassurance from "../assets/qualityassurance.svg";
import smartcontracts from "../assets/smartcontracts.svg";
import publicprivate from "../assets/publicprivate.svg";
import entertainment from "../assets/entertainment.svg";
import verification from "../assets/verification.svg";
import destributed from "../assets/destributed.svg";
...
export const servicesData = [
  ...
  },
  {
    ...
    categories: [{ value: "Animation Services", label: "Animation Services" }],
...
export const OurDevelopmentProcessArray = [
  {
    ...
    info: (
      <>
        ...
        time to understand your needs, business plans, and expectations. If you
        decide to develop an MVP first, we define its scope together. Thanks to
        that, we can give you a general development quotation and schedule.
      </>
    ),
  },
  {
    ...
    info: (
      <>
        ...
        session of Data, Product or Strategy workshops – whatever best fits your
        needs. At the end of this phase, we have wireframes of your app and the
        first design drafts, we’ve gathered development requirements, and
        prepared the basic documentation of the project. All set!
      </>
    ),
  },
  {
    ...
    info: (
      <>
        ...
        designs, and start developing your application. Also, we see you as our
        development partner and that’s why we encourage you to be fully engaged
        throughout the project. The length of this phase depends on the app size
        and complexity. It usually takes us 3 months to create a
  ...
  },
  {
    ...
    info: (
      <>
        ...
        seamlessly, without any downtime. If it’s a mobile app, we take care of
        the app store listings as well. Once your application is live, we also
  ...
  },
  {
    ...
    info: (
      <>
        ...
        The MVP is released, but your journey to success is only beginning! Here
        at Miquido, we aim at building long-term partnerships with our clients.
        We’ll help you improve your product based on the users’ real feedback,
        gather all the analytical data, or introduce additional features to your
        app that will leave your competition without a chance. So, let’s get to
        work!
      </>
    ),
  },
...
export const TechonologiesForStaffArray = [
  {
...
export const TestimonialsSectionArray = [
  {
...
export const GraphicdesignTalentFeatures = [
...
export const whyChooseNative = [
  {
    image: impressiveperformance,
    title: "Impressive performance",
    content: (
      <>
        If application speed and top-notch performance are your priorities, you
        should go for native development. Native iOS apps tend to run faster
        than cross-platform ones, as they are written in Swift, which is
        supported by the platform’s ecosystem
      </>
    ),
  },
  {
  ...
  },
  {
    ...
    content: (
      <>
        As Swift is a more mature language than any of the cross-platform ones,
        it is more dependable when it comes to community support or available
        development resources. They are also less prone to dynamic changes.
        Also, note that Swift is officially supported by Apple. It is in their
        best interest to keep the language up-to-date and dependable in terms of
  ...
  },
  {
    ...
    content: (
      <>
        Thinking about a product that you can expand over the years? Native iOS
        development will be a safe bet here. As a mature, well-supported
  ...
  },
  {
    ...
    content: (
      <>
        ...
        good idea to go for native iOS development. It might be more challenging
        to find skilled cross-platform developers, while building your own team
        of native iOS developers shouldn’t pose a big challenge.
      </>
    ),
  },
  {
    ...
    content: (
      <>
        ...
        mind, there is no need to compromise on the user interface to work well
        on both platforms. Remember that when it comes to iOS native
        development, it’s easier and faster to develop certain platform-specific
        features that may affect the UX, such as widgets or app clips. Also,
        keep in mind that smooth and fast performance of a native application
        makes the user experience more satisfying.
      </>
    ),
  },
];
...
export const androidFeatures = [
  {
    ...
    content: (
      <>
        ...
        mobile app. Choose our all-in-one Android development services and hire
        a team that takes care of everything that your app needs to succeed.
        Strategy and market research to sharpen your vision, and outstanding
        product designs to delight your users. Foolproof app development and
        maintenance for excellent stability and performance. All in one place.
      </>
    ),
  },
  {
    ...
    content: (
      <>
        When it comes to native Android development, there are two technologies
        that matter: Java and Kotlin. Older applications are usually written in
        Java, but most of the new ones are created with Kotlin. Our developers
        are fluent in both, and with each case, they choose the stack carefully
        to deliver top-notch applications, made to fit specific business needs.
        Whether you wish to write a brand new app or spruce up the one you
        already have, we help you choose the right tech solution.
      </>
    ),
  },
  {
    ...
    content: (
      <>
        ...
        world-renowned brands such as Marhaba Mahal, AIDAPro, Friendly Face, or
        Gentleman & Co. We create beautiful, top-performing Android apps for
        industries like e-commerce, banking, music, and travel.
      </>
    ),
  },
  {
    ...
    content: (
      <>
        ...
        Android application development, we can take care of that, too. Our team
        excels in building apps with the two most popular cross-platform
        frameworks: Flutter and React Native.
      </>
    ),
  },
];
export const ServicesAndroidArray = [
  {
    label: "AR VR",
    svg: (
      <svg
...
export const whyChooseNativeAndroid = [
  {
    image: uniquedesign,
    ...
    content: (
      <>
        ...
        <span style={{ color: "#189366" }}>user experience</span>, it’s best to
        pick native development. When it comes to Android native development,
        it’s easier and faster to develop certain platform-specific features
        that may affect the UX. Also, keep in mind that the smooth and fast
        performance of a native application makes the user experience more
        satisfying.
      </>
    ),
  },
  {
    ...
    content: (
      <>
        Planning to equip your app with functions like biometrics, geolocation,
        or features based on Bluetooth connection? The more native features your
        Android app needs, the better to go for the native product. Even
        seemingly simple functionalities such as push notifications tend to
  ...
  },
  {
    ...
    content: (
      <>
        ...
        generally more dependable as well, when it comes to community support or
        available resources. Also, if you’re thinking about expanding your app
        over the years, native development is a future-proof choice. Both Kotlin
        and Java are well-supported languages with rich ecosystems, offering a
        wide variety of open-source libraries, patterns, and articles.
      </>
    ),
  },
  {
  ...
  },
  {
    ...
    content: (
      <>
        If you plan to transfer the project to in-house in the future, it’s a
        good idea to go for native development. It might be more challenging to
        find skilled cross-platform developers, while building your own team of
        native Android developers shouldn’t pose a big problem.
      </>
    ),
  },
];
export const DeliveryCardEntry1 = [
  "Onsite / Offsite Discovery Workshop",
...
export const DeliveryCardEntry2 = [
...
export const DeliveryCardEntry3 = [
  "SLA Based Support",
  "L3 and Production Support Services",
  "Operational support",
  "On-going Support",
];
export const whyBlockChainData = [
  {
    image: (
      <svg
        id="time-fast_1_"
