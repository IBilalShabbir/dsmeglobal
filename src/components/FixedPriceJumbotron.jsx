...
export function FixedPriceJumbotron() {
  return (
    <div className="jumbotron">
      ...
      <Fade bottom distance="30%">
        <div className="jumbotron__heading heading">
          FIXED PRICE LESS EXECUTION RISK
        </div>
      </Fade>
      <Fade bottom distance="30%">
        <div className="jumbotron__info">
          We plan and deliver your product over multiple milestones, leveraging
          a transparent working methodology.
        </div>
      </Fade>
      <Link
        to="/services"
